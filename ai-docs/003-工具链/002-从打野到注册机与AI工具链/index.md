...
HXLoLi 已经有一部分相同的思想, 但组织方式还没有完全变成 ReverseLab 那样的 board/case/KB/tools 路由系统. 可对照已有的 [obsidian-second-brain 全解](../../002-AI/004-记忆/003-obsidian-second-brain/index.md "hxid:hx-a953a087"), 以及当前的 [`hx-to-ai-docs`](../../../../.agents/skills/hx-to-ai-docs/SKILL.md) 与它的各个 `hx-docs-*` 子技能.
