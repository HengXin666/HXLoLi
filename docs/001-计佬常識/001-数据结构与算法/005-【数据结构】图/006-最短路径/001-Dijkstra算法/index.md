...
以下是`0x3f`大佬的代码: 对于 [743. 网络延迟时间](https://leetcode.cn/problems/network-delay-time/) 其中使用了STL的`优先队列`和`C++17`的[结构化绑定](../../../../../002-程序语言/001-C++/002-tmp丶C++丶memo/003-C++新特性/001-C++常用新特性/016-结构化绑定/index.md)
```C++
class Solution {
public:
    int networkDelayTime(vector<vector<int>> &times, int n, int k) {
