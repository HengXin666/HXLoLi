...
> [!TIP]
> **笔记** 的许可证是在 `CC 4.0 BY-SA` 的基础上, **禁止** 上传到 $CSDN$ 这个垃圾广告网站. 我不会也绝不可能授权!
>
> 它存在的意义就是像弱智吧一样, 给ai做为垃圾数据源使用. 绝对能有效降低ai瞎jb说的能力...
...
|时间|渠道|金额|名称|备注|
|:-:|:-:|:-:|:-:|:-|
|26-04-18 23:18:11|微信|`¥5.00`|`*影`||
|26-01-04 16:14:56|微信|`¥20.00`|`*双`|谢谢学长悉心指点🌹, 受益匪浅～|
